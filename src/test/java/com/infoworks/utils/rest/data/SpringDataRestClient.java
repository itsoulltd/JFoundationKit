...
public class SpringDataRestClient<Value extends Any> extends SimpleDataSource<Object, Value> implements DataRestClient<Value> {
    ...
    public SpringDataRestClient(Class<? extends Any> type, URL baseUrl) {
        this(type, baseUrl, new RestTemplate());
    }

    public SpringDataRestClient(Class<? extends Any> type, URL baseUrl, RestTemplate template) {
        this(type, baseUrl, template, Executors.newSingleThreadExecutor());
    }

    public SpringDataRestClient(Class<? extends Any> type, URL baseUrl, ExecutorService service) {
        this(type, baseUrl, new RestTemplate(), service);
    }

    public SpringDataRestClient(Class<? extends Any> type, URL baseUrl, RestTemplate template, ExecutorService service) {
