...
public class EclipseDataStoreTest {
    ...
    public void localFileSystem() {
        ...
        ADirectory directory = fileSystem.ensureDirectoryPath(
                "target", "EclipseStore", "EclipseDataStoreTest", "SimpleStore");
    ...
    public void localFileSystem_using_serializer_jdk_8() {
        ...
        try (EclipseDataStore store = new EclipseDataStore(storageManager, true, Duration.ofMillis(1000))) {
            //TODO:
        } catch (Exception e) {
    ...
    public void blobFileSystem_redis() {
        ...
        //Create storage manager:
        //EmbeddedStorageManager storageManager = EmbeddedStorage.start(directory);
        try (EclipseDataStore store = new EclipseDataStore(directory)) {
            //TODO:
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
