package com.infoworks.utils.cryptor.impl;

import com.infoworks.utils.cryptor.Cryptor;
...
public class AES implements Cryptor {
    ...
    public AES(HashKey hashKey, Transformation transformation, CryptoAlgorithm cryptoAlgorithm) {
