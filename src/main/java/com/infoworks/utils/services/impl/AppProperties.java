...
public class AppProperties implements iProperties {
    ...
    public AppProperties(String name) throws RuntimeException {
        this(name, new HashMap<>());
    }

    public AppProperties(String name, Map<String, String> defaultConfig) throws RuntimeException {
